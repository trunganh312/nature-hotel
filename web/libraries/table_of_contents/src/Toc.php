...
class Toc {
    ...
    public function getDataToc() {
        ...
        for ($i=0, $j=0; $i<$count; $i++, $j++) {
            ...
            $level[$i]      = isset($level[$i]) ? $level[$i] : 0;
            $level[$i+1]    = isset($level[$i+1]) ? $level[$i+1] : 0;
    ...
    public function getToc() {
        ...
        include "{$path_root}libraries/table_of_contents/templates/toc.php";
        $toc = ob_get_clean();
