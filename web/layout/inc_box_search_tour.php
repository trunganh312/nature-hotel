<div class="box_search search_single">
	<div class="tour-search-form-home">
		<div class="search-form">
			<form action="<?=$search_action_form?>" class="form form_search_auto" method="get" id="form_search_tour" onsubmit="return search_main(this);">
				<div class="row">
					<div class="col_search col_search_text">
						<div class="form-group dropdown has-icon dropdown_search_auto" id="dropdown_search">
							...
							<div id="dropdown-destination">
                                ...
                                <div class="render">
                                    <input type="text" autocomplete="off" class="input_search form_input_text" value="<?=$search_keyword?>" data-position="tour" placeholder="Bạn đang muốn đi đâu?" />
