...
<p style="line-height: 1.5;">
    Cảm ơn Quý khách đã sử dụng dịch vụ tại {{ $name }}! Chúng tôi đã nhận được đơn đặt phòng của Quý khách với các thông tin như sau:
</p>
...
<p style="line-height: 1.5;"> Đây là Email gửi thông tin đơn đặt phòng, chưa phải là Email xác nhận đặt phòng thành công. Quý khách vui lòng thanh toán theo hướng dẫn của nhân viên tư vấn để chúng tôi hoàn thành việc xác nhận đơn đặt phòng cho Quý khách.</p>
